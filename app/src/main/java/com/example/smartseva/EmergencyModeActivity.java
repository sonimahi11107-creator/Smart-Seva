...
public class EmergencyModeActivity extends AppCompatActivity {
    ...
    void checkCurrentEmergency() {
        db.collection("emergency").document("current").get()
                ...
                .addOnFailureListener(e -> showNormalStatus());
    }
    ...
    void showActiveBanner(String type, String msg, Long timestamp) {
        ...
        tvEmergencyStatus.setTextColor(
